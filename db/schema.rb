...
ActiveRecord::Schema.define(version: 2023_04_20_073432) do
  ...
  create_table "shipping_destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_id"], name: "index_shipping_destinations_on_order_id"
  end
  ...
  add_foreign_key "shipping_destinations", "orders"
end
